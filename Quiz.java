...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        qno = new JLabel();
        qno.setBounds(100,440,45,30);
        qno.setFont(new Font("Tohma", Font.PLAIN, 20));
        add(qno);
                
        
        question = new JLabel();
        question.setBounds(150,440,850,30);
        question.setFont(new Font("Tohma", Font.PLAIN, 20));
        add(question);
    ...
    //Find below the Answers Array of the above Questions
        ...
        lifeline.setBounds(900, 500, 200, 30);
    ...
    public void paint(Graphics g){
        ...
        try{
            Thread.sleep(1000);  //1sec=1000millisec.
            repaint(); 
        } catch(Exception e){
            e.printStackTrace();
        }
        ...
        if(ans_given == 1){
            ...
            if(count==9){ // submit button case.
                ...
                setVisible(false); // to open new class of frame.
                new Score(name, score);
